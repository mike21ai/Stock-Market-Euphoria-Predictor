...
def inject_global_css():
    ...
    /* Only the footer is hidden. Earlier versions also hid the header and toolbar,
       which removed the control used to reopen a collapsed sidebar. Streamlit's
       own header is left intact and simply made see-through. */
